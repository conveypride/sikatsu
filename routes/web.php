...
// Main Page Route \authentications\LoginBasic@index
...
Route::post('/auth/login-basic', $controller_path . '\authentications\LoginBasic@authenticate')->name('login');

Route::get('/auth/register-basic', $controller_path . '\authentications\RegisterBasic@index')->name('auth-register-basic');
Route::post('/auth/register-basic', $controller_path . '\authentications\RegisterBasic@storeUser')->name('register');
