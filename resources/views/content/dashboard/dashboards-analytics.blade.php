      ...
      <div class="d-flex align-items-end row">
        <div class="col-sm-7">
          <div class="card-body">
            ...
            <p class="mb-4">To Your <span class="fw-bold">Sikatsu</span> Dashboard.</p>
  ...
  <div class="col-12 m-2">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="card-title text-nowrap mb-1"> ¢ {{ $totaldeposit }}</h3>
      ...
      <div class="col-12 m-2">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="card-title text-nowrap mb-1"> ¢ {{ $totalwithdrwan }}</h3>
            {{-- <small class="text-success fw-semibold"><i class='bx bx-up-arrow-alt'></i> +28.42%</small> --}}
          </div>
        </div>
      </div>
      ...
      <div class="col-12 m-2">
        <div class="card">
          <div class="card-body">
            ...
            <h3 class="card-title text-nowrap mb-2">¢ {{ $balance }}</h3>
